...
public class MyInterface extends MyAgent {
    ...
    private static final String[] columnNames = {
            "Agent", "Floor", "Weight (kg)", "Num. requests", "State", "Next floor to stop",
            "Num. people", "CFPs sent", "Proposes sent", "Refuses sent", "Accept proposals sent",
            "Accept proposals received", "People entrance time (ms)", "People exit time (ms)",
            "Min. wait time (ms)", "Max. wait time (ms)", "Uptime (ms)", "Downtime (ms)", "Use rate (%)",
            "Max. weight (kg)", "Movement time (ms)", "Person entrance time (ms)", "Person exit time (ms)"
    };
